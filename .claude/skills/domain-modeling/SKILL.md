...
When a term is resolved, update `CONTEXT.md` right there. Don't batch these up. `CONTEXT.md` is a glossary and nothing else — no implementation details, no specs, no scratch-pad content.
